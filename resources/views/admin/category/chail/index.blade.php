  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">chail Category</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">All chail categories list here</h3>
              </div>
              <!-- /.card-header -->
                <div class="card-body">
...
<div class="modal fade" id="categoryModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="{{ route('chailcategory.store') }}" method="Post" id="add_form" enctype="multipart/form-data">
      	@csrf
      <div class="modal-body">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control"  name="chail_name" required="">
          </div>
      </div>
...
$(function category(){
          table=$('.ytable').DataTable({
            ...
            columns:[
              ...
              {data:'chail_name',name:'chail_name'},
              {data:'chail_slug',name:'chail_slug'},	
	...
	$('body').on('click','.edit', function(){
		...
		$.get("chailcategory/edit/"+cat_id, function(data){
