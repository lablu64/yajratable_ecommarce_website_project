...
<style type="text/css">
  ...
  color: orange;
	...
	<div class="banner">
		...
		<div class="container fill_height">
			<div class="row fill_height">
				<div class="banner_product_image" height="521" width="249"><img src="{{ asset('public/files/product/'.$bannarproduct->thumbnail) }}" alt=""></div>
				<div class="col-lg-5 offset-lg-4 fill_height">
					<div class="banner_content">
						<h1 class="banner_text">{{ $bannarproduct ->name }}</h1>

					   @if($bannarproduct->discount_price == NULL)
						<div class="banner_price">{{ $setting->currency }}{{ $bannarproduct ->selling_price }}</div>
						@else
						<div class="banner_price"><span>{{ $setting->currency }}{{ $bannarproduct ->selling_price }}</span>{{ $setting->currency }}{{ $bannarproduct ->discount_price }}</div>
						@endif

						<div class="banner_product_name">{{ $bannarproduct->brand->brand_name }}</div>
						
						<div class="button banner_button"><a href="{{ route('product.details',$bannarproduct->slug) }}">Shop Now</a></div>
					</div>
				</div>
			</div>
		</div>
					...
					<div class="deals">
						...
						<div class="deals_slider_container">
							...
							<div class="owl-carousel owl-theme deals_slider">
								@foreach ($today_deal_product as $row )
								<!-- Deals Item -->
								<div class="owl-item deals_item">
									<div class="deals_image"><img src="{{ asset('public/files/product/'.$row->thumbnail) }}" alt=""></div>
									<div class="deals_content">
										...
										<div class="deals_info_line d-flex flex-row justify-content-start">
											...
											@else
											<div class="deals_item_price ml-auto text-success">{{ $setting->currency }}{{ $row ->discount_price }}</div>
											@endif
                                   ...
                                   @foreach ($featured_product as $row )
									...
									<div class="featured_slider_item">
										...
										<div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
											<div class="product_image d-flex flex-column align-items-center justify-content-center"><img height="90%" width="70%"  src="{{ asset('public/files/product/'.$row->thumbnail) }}" alt=""></div>
											<div class="product_content">
												...
												<div class="product_extras">
													...
													<a href="javascript:void(0)"  id="{{ $row->id }}" class="text-primary quick_view" data-toggle="modal" data-target="#exampleModal">
														Quick view
													  </a>
									...
									<div class="featured_slider_item">
										...
										<div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
											...
											<div class="product_content">
												...
												<div class="product_name"><div><a href="{{ route('product.details',$row->slug) }}">{{ Str::substr($row->name, 0, 60) }}</a></div></div>
												<div class="product_extras">
													{{-- <div class="product_color">
														
													</div> --}}
													<a href="javascript:void(0)"  class="text-primary quick_view" id="{{ $row->id }}" data-toggle="modal" data-target="#exampleModal">
														Quick view
													  </a>
													  <button class="product_cart_button">Add to Cart</button>
	...
	{{-- bootrap modal featured product view start --}}
  ...
  {{-- boostrap modal featured product view end --}}
							...
							@foreach ($category as $row )
								<div class="owl-item">
									<div class="popular_category d-flex flex-column align-items-center justify-content-center">
										...
										<div class="popular_category_text">{{ Str::substr($row->category_name,0, 30) }}</div>
									</div>
								</div>
				...
				<div class="col">
					<div class="tabbed_container">
						<div class="tabs clearfix tabs-right">
							<div class="new_arrivals_title">{{ $item->category_name }}  </div>
							<ul class="clearfix">
						...
						<div class="row">
							<div class="col-lg-12" style="z-index:1;">
								...
								<!-- Product Panel -->
								@php
							  $cate_product =DB::table('products')->where('category_id',$item->id)->orderBy('id', 'DESC')->take(20)->get();
								@endphp
								<div class="product_panel panel active">
									<div class="arrivals_slider slider">
                                       @foreach ($cate_product as $row )
										...
										<div class="arrivals_slider_item">
											...
											<div class="product_item is_new d-flex flex-column align-items-center justify-content-center text-center">
												...
												<ul class="product_marks">
													<li class="product_mark product_discount"><a href="javascript:void(0)"   id="{{ $row->id }}" class="quick_view text-white" data-toggle="modal" data-target="#exampleModal"><i  class="fas fa-eye" aria-hidden="true"></i> </a></li>
													<li class="product_mark product_new"></li>
												</ul>
											</div>
										</div>
								...
								<div class="trends_item is_new">
									...
									<div class="trends_content">
										...
										<div class="trends_info clearfix">
											...
											@else
											<div class="trends_price"><del class="text-danger">{{ $setting->currency }}{{ $row ->selling_price }}</del>  {{ $setting->currency }}{{ $row ->discount_price }}</div>
											@endif
									...
									<ul class="trends_marks">
										...
										<li class="trends_mark trends_new"><a href="javascript:void(0)"   id="{{ $row->id }}" class="quick_view text-white" data-toggle="modal" data-target="#exampleModal"><i class="fas fa-eye"></i> </a></li>
									</ul>
				...
				<div class="col">
					...
					<div class="reviews_slider_container">
						...
						<div class="owl-carousel owl-theme reviews_slider">
							...
							@foreach ($custorm_reviews as $row )
							<!-- Reviews Slider Item -->
							<div class="owl-item">
								<div class="review d-flex flex-row align-items-start justify-content-start">
									...
									<div class="review_content">
										...
										<div class="review_text"><p>{{ Str::substr($row->review, 0, 100) }}..</p></div>
									</div>
								</div>
							</div>
							@endforeach
								...
								<div class="viewed_item discount d-flex flex-column align-items-center justify-content-center text-center">
									...
									<div class="viewed_content text-center">
										<div class="viewed_name"><a href="{{ route('product.details',$row->slug) }}">{{ $row->name }}</a></div>
											...
											@else
											<div class="viewed_price"><del class="text-danger">{{ $setting->currency }}{{ $row ->selling_price }}</del>  {{ $setting->currency }}{{ $row ->discount_price }}</div>
											@endif	
									</div>
									<ul class="item_marks">
						...
						<div class="owl-carousel owl-theme brands_slider">
							...
							<div class="owl-item">
								<div class="brands_item d-flex flex-column justify-content-center">
									...
									<h2 style="font-size: 14px;">{{ $row->brand_name }}</h2>
								</div>
				...
				<div class="col">
					<div class="newsletter_container d-flex flex-lg-row flex-column align-items-lg-center align-items-center justify-content-lg-start justify-content-center">
						...
						<div class="newsletter_content clearfix">
							<form action="{{ route('store.newsletter') }}" method="POST" id="newsletter_customar" class="newsletter_form">
								@csrf
