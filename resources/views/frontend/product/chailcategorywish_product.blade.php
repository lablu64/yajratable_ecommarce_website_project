...
<div class="super_container">
	...
	<div class="home">
		...
		<div class="home_content d-flex flex-column align-items-center justify-content-center">
			<h2 class="home_title">{{ $chailcategory->chail_name }}</h2>
		</div>
	</div>
	<!-- Shop -->
					...
					<div class="shop_sidebar">
						<div class="sidebar_section">
							...
							<ul class="sidebar_categories">
								...
								<li><a href="{{ route('categorywish.product',$row->id) }}">{{ $row->category_name }}</a></li>
						...
						<div class="sidebar_section">
							...
							<ul class="brands_list">
								@foreach ($brand as $row )
								    <li class="brand"><a href="{{ route('brandwish.product',$row->id) }}">{{ $row->brand_name }}</a></li>	
								@endforeach
                            ...
                            @foreach ($products as $row )    
								<div class="product_item is_new">
									<div class="product_border"></div>
										...
										<div class="product_image d-flex flex-column align-items-center justify-content-center"><img height="90%" width="50%" src="{{ asset('public/files/product/'.$row->thumbnail) }}" alt=""></div>
										<div class="product_content">
											@if($row->discount_price == NULL)
											<div class="product_price discount" style="margin: 0px;">{{ $setting->currency }}{{ $row ->selling_price }}</div>
											@else
											<div class="product_price discount text-success" style="margin: 0px;"><del class="text-danger">{{ $setting->currency }}{{ $row ->selling_price }}</del>  {{ $setting->currency }}{{ $row ->discount_price }}</div>
											@endif
